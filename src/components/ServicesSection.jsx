  ...
  const services = [
    {
      icon: FiHome,
      title: 'Construcción',
      description: 'Construcción y ampliación de viviendas, edificios residenciales, locales comerciales e industriales con enfoque técnico, cumplimiento de plazos y altos estándares de calidad.',
    ...
    },
    {
      ...
      description: 'Supervisión técnica para asegurar que la obra cumpla expediente técnico, especificaciones, normativa vigente y control de tiempos, costos y calidad en cada etapa.',
    ...
    },
    {
      ...
      description: 'Gestión de obras públicas o privadas y habilitaciones urbanas, con control técnico de obra, seguimiento integral, validación documental, coordinación y cumplimiento normativo.',
    ...
    },
    {
      ...
      description: 'Regularización de propiedades con respaldo técnico y legal mediante trámites que aseguran seguridad jurídica, cumplimiento normativo y orden documental.',
